...
@objcMembers
open class PullUpControllerNew: UIViewController {
...
@objc extension UIViewController {
     ...
     */
    open func addPullUpController(_ pullUpController: PullUpControllerNew,
     ...
     */
    open func removePullUpControllerNew(_ pullUpController: PullUpControllerNew, animated: Bool) {
...
extension UIScrollView {
     ...
     */
    open func attach(to pullUpController: PullUpControllerNew) {
     ...
     */
    open func detach(from pullUpController: PullUpControllerNew) {
