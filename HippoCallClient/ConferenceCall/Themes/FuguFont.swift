...
public class FuguFont: UIFont {
    ...
    public static func titilliumWebSemiBold(with size: CGFloat = 14) -> UIFont {
        return UIFont.systemFont(ofSize: size)//UIFont.init(name: "TitilliumWeb-SemiBold", size: size)!
    }
    
    public static func titilliumWebRegular(with size: CGFloat = 14) -> UIFont {
        return UIFont.systemFont(ofSize: size)//UIFont.init(name: "TitilliumWeb-Regular", size: size)!
    }

    public static func titilliumWebBold(with size: CGFloat = 14) -> UIFont {
        return UIFont.systemFont(ofSize: size)//UIFont.init(name: "TitilliumWeb-Bold", size: size)!
    }
    
    public static func titilliumWebItalic(with size: CGFloat = 14) -> UIFont {
        return UIFont.systemFont(ofSize: size)//UIFont.init(name: "TitilliumWeb-Italic", size: size)!
    }
