...
public class Call {
    ...
    public init(peer: CallPeer, signalingClient: SignalingClient, uID: String, currentUser: CallPeer, type: CallType, link: String, isGroupCall : Bool = false, jitsiUrl : String, transactionId: String? = nil) {
        self.peer = peer
